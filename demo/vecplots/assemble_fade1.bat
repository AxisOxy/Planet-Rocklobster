...
vc -O2 -notmpfile -nostdlib -o "vecfade.exe" "vecfade1.asm"

copy vecfade.exe "..\winuae\hd0"

@echo /|set /p =vecfade.exe>"..\winuae\hd0\s\startup-sequence"
