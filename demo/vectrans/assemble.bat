...
vc -O2 -notmpfile -nostdlib -o "vectrans.exe" "vectrans2.asm"

copy vectrans.exe "..\winuae\hd0"

@echo /|set /p =vectrans.exe>"..\winuae\hd0\s\startup-sequence"
