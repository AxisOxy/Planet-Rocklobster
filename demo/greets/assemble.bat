...
vc -O2 -notmpfile -nostdlib -o "greets.exe" "greets.asm"

copy greets.exe "..\winuae\hd0"

@echo /|set /p =greets.exe>"..\winuae\hd0\s\startup-sequence"
