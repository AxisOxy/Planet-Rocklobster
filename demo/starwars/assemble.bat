...
vc -O2 -notmpfile -nostdlib -o "starwars.exe" "starwars.asm"

copy starwars.exe "..\winuae\hd0"

@echo /|set /p =starwars.exe>"..\winuae\hd0\s\startup-sequence"
