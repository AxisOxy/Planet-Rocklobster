...
vc -O2 -notmpfile -nostdlib -o "launcher.exe" "launcher.asm"

copy launcher.exe "..\winuae\hd0"

@echo /|set /p =launcher.exe>"..\winuae\hd0\s\startup-sequence"
