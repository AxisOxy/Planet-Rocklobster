...
vc -O2 -notmpfile -nostdlib -o "voxelfade.exe" "voxelfade.asm"

copy voxelfade.exe "..\winuae\hd0"

@echo /|set /p =voxelfade.exe>"..\winuae\hd0\s\startup-sequence"
