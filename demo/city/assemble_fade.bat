...
vc -O2 -notmpfile -nostdlib -o "city_fade.exe" "city_fade.asm"

copy city_fade.exe "..\winuae\hd0"

@echo /|set /p =city_fade.exe>"..\winuae\hd0\s\startup-sequence"
