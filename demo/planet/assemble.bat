...
vc -O2 -notmpfile -nostdlib -o "planet.exe" "planet.asm"

copy planet.exe "..\winuae\hd0"

@echo /|set /p =planet.exe>"..\winuae\hd0\s\startup-sequence"
